...
int add_hash(book *ptr,struct student *hasht,struct student *ne);
int rmv_hash(book *ptr,struct student *hasht,struct student *del);
...
int find_by_name (book *ptr ,struct student *hash, char name[]);

// function project 1
void clear (book *ptr,struct student *hasht);
int  add (book *ptr,struct student *hasht,const long unsigned int AEM,const char name[],const short unsigned int mathima,const int K);
...
int rmv (book *ptr,struct student *hasht,const long unsigned int AEM,const int K);
void sort (book *ptr);
void quit (book *ptr,struct student *hasht);

int main(int argc ,char *argv[]){
    int M=0,K=0,H=0,i=0,maxs;
    book univer,*books;
    struct student *ptr,*hasht;
    long unsigned int AEM;
    char NAME[64];
    char menu;
...
//desmesi kai arxikopoisi tou pinaka
    ...
    hasht = (struct student *) malloc(H*sizeof(struct student));
...
int add_hash(book *ptr ,struct student *hasht,struct student *neo){
    unsigned long int k;
    int i,new, LF;
    struct student *next,*new_hash, *head, *ne ;
    ...
    {//gia ayjisi toy pinaka
        new_hash = (struct student *) malloc((ptr->max_hash * 2)*sizeof(struct student));
        if(new_hash == NULL){
            printf("NO space");
            return 0;
        }
...
int rmv_hash(book *ptr,struct student *hash,struct student *del){
    int i,j,max,pply , LF;
...
int find_by_name(book *ptr,struct student *hasht, char name[]){
    unsigned long int k;
    int i ,metritis=0;
